...
export const PORTAL_BANNER_ADMIN_DEFS: readonly PortalBannerFieldAdminDef[] = [
  ...
  },
  {
    ...
    ayudaParaAdmin: "Si ya aparece arriba en la página, suele ser innecesario repetirlo; puede ocultarlo.",
    defaultOrder: 48,
    hiddenByDefault: true,
  },
  {
  ...
  },
  {
    ...
    ayudaParaAdmin: "Útil si desea destacar también la fecha de comienzo del evento.",
    defaultOrder: 105,
    hiddenByDefault: false,
  },
  {
